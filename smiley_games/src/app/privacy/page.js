...
export default function PrivacyPolicy() {
  return (
    <main>
      <div className="max-w-prose m-auto space-y-3 p-3">
        <h1 className="text-3xl text-center font-bold">Privacy Policy</h1>
        <p>
          Welcome to our Privacy Policy, where we navigate the treacherous
          waters of legal jargon to tell you what we&apos;re doing with your
          data. Here&apos;s the lowdown, in plain-ish English:
        </p>
